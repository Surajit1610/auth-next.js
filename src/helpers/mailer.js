...
export const sendEmail = async({email, emailType, userId})=> {
    ...
    const mailOptions = {
        ...
        html: `<p>Click <a href="https://${process.env.DOMAIN}/${emailType === "VERIFY" ? "verifyemail" : "forgotpassword"}?token=${hashedToken}">here</a> to ${emailType === "VERIFY" ? "verify your email" : "reset your password"}
